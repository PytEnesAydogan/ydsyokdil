...
public class zorKelimeler extends AppCompatActivity {

    String[] Eng_kelimeler = { "SURFACE", "STRUCTURE",
            "EAR", "TYPE","BANDAGE",
            "BEHAVE","ALSO", "DEPOSIT","FAITH",
            "SOLAR","BETTER","SIZE","LESS","LEGAL",
            "BREATH","SCIENCE","NEGATIVE"

    };

    String[] Tur_Anlamlar = {"YÜZEY", "YAPILANDIRMAK,DÜZENLEMEK",
            "KULAK" ,"TÜR,CİNS ","SARGI",
            "DAVRANMAK","DE,DA,AYRICA" ,"KAPORA","İNANÇ",
            "GÜNEŞLE İLGİLİ","DAHA İYİ","BÜYÜKLÜK,BOYUT",
            "...-DEN DAHA AZ,DAHA AZ",
            "YASAL","NEFES,SOLUK","BİLİM","EKSİ,OLUMSUZ",
    ...
    public static class zor2Kelimeler extends AppCompatActivity {
    ...
    public static class zor3Kelimeler extends AppCompatActivity {
    ...
    public static class zor4Kelimeler extends AppCompatActivity {
    ...
    public static class zor5Kelimeler extends AppCompatActivity {
    ...
    public static class zor6Kelimeler extends AppCompatActivity {
    ...
    public static class zor7Kelimeler extends AppCompatActivity {
    ...
    public static class zor8Kelimeler extends AppCompatActivity {
    ...
    public static class zor9Kelimeler extends AppCompatActivity {
    ...
    public static class zor10Kelimeler extends AppCompatActivity {
